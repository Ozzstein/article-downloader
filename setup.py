...
url = 'https://github.com/Ozzstein/article-downloader', # use the URL to the github repo
download_url = 'https://github.com/Ozzstein/article-downloader/tarball/9.1.1',
